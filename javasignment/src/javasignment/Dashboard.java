...
public class Dashboard extends JFrame {
	...
	public Dashboard() {
		...
		lblNewLabel_16.setBounds(10, 10, 82, 72);
		panel_2.add(lblNewLabel_16);
		
		JLabel lblNewLabel_17 = new JLabel("New label");
		lblNewLabel_17.setIcon(new ImageIcon(Dashboard.class.getResource("/javasignment/Herald (1) (1).png")));
		lblNewLabel_17.setBounds(563, 10, 152, 72);
		...
		btnNewButton_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {  // add button for teacher
		        ...
		        try {
		            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/coursemanage", "root", "");
		            String insertSql = "INSERT INTO teacher (Username, Email, Phone, Course) VALUES (?, ?, ?, ?)";
		...
		lblNewLabel_7.setBounds(542, 104, 45, 13);
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {  
		        ...
		        try {
		            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/coursemanage", "root", "");
		            String insertSql = "INSERT INTO student (Username, Email, Phone, Course) VALUES (?, ?, ?, ?)";
		            PreparedStatement updateStmt = conn.prepareStatement(insertSql);
		...
		lblNewLabel_4.setBounds(535, 354, 78, 13);
